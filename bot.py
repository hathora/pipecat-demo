...
if __name__ == "__main__":
    room_config = json.loads(os.getenv("HATHORA_INITIAL_ROOM_CONFIG"))
    if not room_config:
        raise Exception("HATHORA_INITIAL_ROOM_CONFIG is not set")

    asyncio.run(main(room_config["room_url"], room_config["token"]))
